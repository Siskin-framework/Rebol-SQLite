...
#define EXT_SQLITE_INIT_CODE \
	"REBOL [Title: \"Rebol SQLite Extension\" Name: sqlite Type: module Exports: [] Version: 3.46.0.0 Needs:   3.13.1 Author: Oldes Date: 23-Feb-2026/8:20:41 License: MIT Url: https://github.com/Siskin-framework/Rebol-SQLite]\n"\
